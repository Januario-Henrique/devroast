							...
							<div className="flex items-center gap-12">
								...
								<div className="flex-1 flex flex-col gap-4">
									<div className="flex items-center gap-2">
										...
										/>
										<span
											className={`text-accent-${analysis.verdict === "needs_serious_help" ? "red" : analysis.verdict === "needs_improvement" ? "amber" : analysis.verdict === "good" ? "green" : "text-secondary"} text-sm font-medium`}
										>

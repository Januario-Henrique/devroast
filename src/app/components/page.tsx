    ...
    <main className="min-h-screen bg-bg-page p-8">
      <div className="max-w-4xl mx-auto space-y-12">
        <div className="border-b border-border-primary pb-8">
          <h1 className="text-text-primary text-3xl font-bold mb-2">UI Components</h1>
          <p className="text-text-secondary">Component showcase with all variants</p>
        </div>
        ...
        <section className="space-y-6">
          ...
          <div className="space-y-4">
            <h3 className="text-text-secondary text-sm font-medium">Variants</h3>
          ...
          {/* All combinations */}
          <div className="space-y-4">
            <h3 className="text-text-secondary text-sm font-medium">All Combinations</h3>

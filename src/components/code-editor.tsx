...
function CodeEditor({
	...
	const effectiveLanguage = language ?? (autoDetect ? detectedLanguage : null);
	const displayLanguage = effectiveLanguage
		? (LANGUAGES[effectiveLanguage]?.name ?? effectiveLanguage)
		: null;
